package com.neversleeps.user.dsl

import com.neversleeps.user.models.Action
import com.neversleeps.user.models.User
...
class UserBuilder {
    ...
    @UserDsl // повлияет только на подсветку при использовании функции
...
@UserDsl1 // повлияет только на подсветку при использовании функции buildUser()
